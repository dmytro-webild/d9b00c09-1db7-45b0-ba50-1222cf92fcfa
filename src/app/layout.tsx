...
export const metadata: Metadata = {
  title: "Royal Wrist NG - Luxury Watches Nigeria",  description: "Discover premium luxury watches from Switzerland's finest watchmakers. Royal Wrist offers exclusive timepieces with nationwide delivery in Nigeria.",  keywords: "luxury watches, premium timepieces, Swiss watches, Nigeria, Abuja, wristwatch, chronograph",  openGraph: {
    title: "Royal Wrist NG - Luxury Watches Collection",    description: "Premium luxury watches curated for discerning customers. Shop exclusive timepieces with nationwide delivery.",    type: "website",    siteName: "Royal Wrist NG",    images: [
      {
        url: "http://img.b2bpic.net/free-photo/fashion-portrait-young-businessman-handsome-model-man-casual-cloth-suit-with-accessories-hands_158538-9455.jpg",        alt: "Royal Wrist Luxury Watches"},
    ],
  },
  twitter: {
    card: "summary_large_image",    title: "Royal Wrist NG - Luxury Watches",    description: "Exclusive luxury watches from Switzerland. Premium timepieces available in Nigeria.",    images: ["http://img.b2bpic.net/free-photo/fashion-portrait-young-businessman-handsome-model-man-casual-cloth-suit-with-accessories-hands_158538-9455.jpg"],
  },
};
